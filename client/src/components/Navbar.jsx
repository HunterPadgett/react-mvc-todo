   ...
   <div className="justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
    ...
    <div>
     ...
     >
      ...
      <ul className="mt-5 w-1/4 space-y-5 lg:hidden md:hidden">
       <li className=" px-4 py-2 text-center text-white bg-gray-600 rounded-md shadow hover:bg-gray-800 cursor-pointer">
        <Link to={"/login"}>Login</Link>
       </li>
       <li className="  px-4 py-2 text-center text-gray-800 bg-white rounded-md shadow hover:bg-gray-100">
